...
export default {
  ...
  RegisterMessage:
    symbolsData.HiEmo +
    "Добрый день! Для работы с ситемой Введите ваш корпоративный E-Mail",
  PleaceEnterMessage: symbolsData.LockerEmo + " Пожалуйста войдите",
  AccessDeniedMessage:
    symbolsData.LockerEmo +
  ...
  EnterSubnetP2PMessage:
    "Введите IP-адрес в формате <i><code>A.B.C.D/Mask(30)</code></i>",
  EnterSubnetIpMessage:
    "Введите IP-адрес в формате <i><code>A.B.C.D/Mask(0-32)</code></i>)",
  //Error Messages
