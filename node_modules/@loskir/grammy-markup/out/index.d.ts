import { type InlineKeyboardButton, type KeyboardButton, KeyboardButtonRequestChat, KeyboardButtonRequestUser, type LoginUrl } from "./deps.node.js";
export declare const Button: {
     ...
     */
    requestUser(text: string, requestId: number, options?: Omit<KeyboardButtonRequestUser, "request_id">): KeyboardButton.RequestUserButton;
    /**
     ...
     * @param options Options object for further requirements
     */
    requestChat(text: string, requestId: number, options?: Omit<KeyboardButtonRequestChat, "request_id">): KeyboardButton.RequestChatButton;
    /**
...
export declare const IButton: {
     ...
     */
    text(text: string, data?: string): InlineKeyboardButton.CallbackButton;
    /**
